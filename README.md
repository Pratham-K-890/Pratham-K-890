...
**AI/LLM:** RAG (pgvector, sentence-transformers) · LLM tool calling · LangChain · LangGraph · CrewAI · Groq API · Gemini API
**Other:** Java · Computer Vision (PyTorch)
**Deployment:** Docker · Railway · Render · Vercel · CI/CD
